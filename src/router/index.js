...
import waveSend from '@/views/waveSend'
...
export const asyncRouterMap = [

    {
        ...
        hidden: false,
        children: [
            { path: '/waveSend', name: '流量实验', icon: 'ios-paper', component: waveSend },
            ...
            //   },
            {
                path: '/charts', name: '数据展示', redirect: '/charts/shopchart', icon: 'pie-graph',
                component: { render(c) { return c('router-view') } },
                children: [{ path: 'shopchart', name: '一级指标', icon: 'stats-bars', component: _import('charts/ShopChart'), hidden: false, },
                    { path: 'radarchart', name: '二级指标', icon: 'arrow-graph-up-right', component: _import('charts/RadarChart') },
            ...
            { path: '/introduction', name: '系统帮助', icon: 'thumbsup', component: _import('Introduction') },
            { path: '/dashboard', name: '框架介绍', icon: 'speedometer', component: _import('Dashboard') }
        ]
    },
